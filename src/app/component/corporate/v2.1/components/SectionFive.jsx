              ...
              <div className="bg">
                <picture>
                  <source
                    ...
                    srcSet="./corporate-v2/botton_section.webp"
                    data-srcset="./corporate-v2/botton_section.webp"
                  />
                  <img
                    alt="Eventgäste an einer Bar"
                    className="lazy"
                    src="./corporate-v2/botton_section.webp"
                    data-src="./corporate-v2/botton_section.webp"
                  />
                </picture>
              </div>
            </div>
