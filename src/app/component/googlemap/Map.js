...
export default function Map() {
  ...
  return (
    <div className="container-fluid p-lg-5 p-3 bg-black">
      <p style={{ fontSize: '28px' }} className=" text-center text-white">Our Print-Media & Electronic-media Channel Partner's Globally! </p>
