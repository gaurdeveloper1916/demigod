            ...
            <div className="container-fluid p-5 lovestory-bg-color">
                ...
                <div className="row align-items-center  justify-content-center mb-5">
                    ...
                    <div className="col-12 col-lg-8 bg-white p-4 rounded">
                        ...
                        Maharashtrian weddings are known for their simplicity and elegance, with rituals that reflect the region's deep cultural roots. The wedding ceremony includes the 'Phool Pathak' (flower ceremony) and the 'Saat Phere' (seven vows), signifying the couple's lifelong commitment. These weddings bring together the beauty of traditional attire, vibrant colors, and close-knit family celebrations.                        </p>
                    </div>
                </div>
                ...
                <div className="row align-items-center  justify-content-center mb-5">
                    ...
                    <div className="col-12 col-lg-8 bg-white p-4 rounded">
                        ...
                        MMarwari weddings are known for their grandeur, opulent rituals, and family-driven ceremonies. The wedding kicks off with traditional rituals like 'Ganesh Puja' and 'Tilak,' setting the stage for the wedding celebrations. From ornate decorations to elaborate feasts, every moment reflects the rich cultural heritage of the Marwari community, making it a lavish affair to remember.</p>
                    </div>
                </div>
                <div className="row align-items-center  justify-content-center mb-5">
                    <div className="col-12 col-lg-3 mb-4 mb-lg-0">
                    ...
                    <div className="col-12 col-lg-8 bg-white p-4 rounded">
                        ...
                        Telugu weddings are a spiritual journey, rich with sacred rituals and timeless customs that honor both the couple and their families. Key ceremonies include the 'Kanyadaan' (giving away of the bride) and 'Talambralu,' where the bride and groom shower each other with sacred rice. These weddings are marked by deep respect for tradition, with a focus on unity, prosperity, and familial bonds.Telugu weddings are a spiritual journey, rich with sacred rituals and timeless customs that honor both the couple and their families. Key ceremonies include the 'Kanyadaan' (giving away of the bride) and 'Talambralu,' where the bride and groom shower each other with sacred rice. These weddings are marked by deep respect for tradition, with a focus on unity, prosperity, and familial bonds.</p>
                    </div>
                </div>
