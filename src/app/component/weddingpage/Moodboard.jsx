        ...
        <div className=" d-flex flex-lg-row flex-md-row flex-column  gap-3">
          <div className="">
            <img
              ...
              className="img-fluid bounce-effect text-0px"
          ...
          <div className=""  onClick={() => handleImageClick("Image/wedding-page/mood-1/arabic.webp","Opulent Celebrations, Rich Culture Arabic weddings are magnificent celebrations that blend traditional customs with lavish festivities. Known as 'Zaffa,' the wedding procession features traditional music and dance. The ceremony includes the signing of the marriage contract (Nikah) and exchange of rings. These weddings are characterized by their grandeur, with elaborate decorations, traditional music, sumptuous feasts, and the bride's stunning henna designs (Mehndi), creating an atmosphere of luxury and cultural richness.","Arabic Wedding")}>
            <img
              alt="image"
              src="/Image/arabic.webp"
              className="img-fluid bounce-effect rounded"
             
              style={{ cursor: "pointer", width: "300px", height: "250px", objectFit: "cover" }}
            />
            {/* <p className="text-center shake-effect mt-2">Click me<BookUpIcon/> </p> */}
          </div>
        </div>
