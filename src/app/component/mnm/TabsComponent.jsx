    ...
    return (
        <>
            <div className="w-full ">
                <ul
                    className="d-flex gap-2 mb-1 overflow-x-auto lg:overflow-hidden lg-px-4"
                    role="tablist"
                    ...
                    {tabs.map((tab) => (
                        <li className="d-flex justify-content-center align-items-center" key={tab.id}
                            ...
                            <button
                                ...
                                className={`mediumFont border-0 rounded px-4 py-2 text-black text-lg ${activeTab === tab.id ? "tab-css-button-slected" : "tab-css-button"
                                    }`}  >
                                {tab.label}
                            </button>
            ...
            <div className="">
                    ...
                    <div className="d-flex flex-lg-row flex-column  ">
                        ...
                        <div className="col-lg-5">
                            ...
                            >
                                ...
                                />
                                <div className="info_card p-3 text-black">
                            ...
                            <ul className=" d-flex flex-column gap-2">
                                <div>
                                    <ul class="list-unstyled">
                                        <li class="mb-3">At DemiGod House, we avail end-to-end Brand Marketing, Brand Strategizing, Brand Development, BrandSeed Funding & capital procurement, Brand Product’s contract manufacturing, Brand advertising in Print Media / Electronic Media, and B2B / B2C Events for Brand ATL / BTL promotion!</li>
                                            <hr></hr>
                                        <li class="mb-3">We are a powerhouse of strategic marketing and brand elevation, ensuring a brand’s success story unfolds seamlessly across global and domestic markets.</li>
                                        <hr></hr>
                                        <li class="mb-3">Our flagship offerings include Brand Association and Capital Procurement—where we collaborate with industrial leaders to fuel strategic brand growth and redefine market dominance.</li>
                                        <hr></hr>
                                        <li class="mb-3">DemiGod House exists at the intersection of luxury, influence, and scale, strategically positioned to deliver high-value investment returns and <strong>building legacy-driven brands that leave a lasting impact.</strong></li>
                                        <hr></hr>
                                        <li class="mb-3">The primary objective of association with DemiGod House is to elevate the product’s sale by strategically aligning our marketing resources and capital investments, ultimately fostering long-term growth, brand loyalty, and higher revenue.</li>
                                    </ul>
                                </div>
                ...
                <div className={`tab-pane fade  mt-12 ${activeTab === "ex2-tabs-2" ? "show active" : ""}`}>
                    <div className="d-flex flex-lg-row flex-column gap-6 ">
                        ...
                        <div className="col-lg-7 p-3 d-flex flex-column align-items-center mx-auto  p-3">
                            {/* <p className="fw-bold text-black">Our Approach:</p> */}
                    ...
                    <div className="d-flex flex-lg-row flex-column gap-6 ">
                        <div className="col-lg-5">
                            ...
                            >
                                ...
                                <div className="info_card p-3 text-black">
                                    <h1 className="colo-bg fw-bold largefont text-start text-black fs-4">
                ...
                <div className={`tab-pane fade  ${activeTab === "ex2-tabs-5" ? "show active" : ""}`}>
                    <div className="d-flex flex-lg-row flex-column  ">
                        ...
                        <div className="col-lg-7 p-3 d-flex flex-column align-items-center mx-auto  p-3">
                            {/* <h5> <p className="fw-bold text-black"></p></h5> */}
