                    ...
                    </div>
                    {
                      ...
                      <div style={{ left: '9rem' }} className="position-absolute top-0 mt-4 ">
                        <div className="d-flex justify-content-center flex-column align-items-center text-center px-3">
                          <h1 className="display-3 text-white fw-bold text-shadow" >THE GRAND POUR</h1>
                          <p className="fs-4 text-white fst-italic mb-5 text-shadow" >“Experience the Elegance”</p>
                        </div>
                      </div>
                      <div style={{ top: '11rem' }} className="position-absolute  ">
                        <div style={{ backgroundColor: "#0000009c", borderTopRightRadius: '30px', borderBottomRightRadius: '30px' }}>
                          <p className="px-5 py-3 text-white mediumfont">2 weekend of october</p>
  
                        </div>
                        <div style={{ backgroundColor: "#0000009c", borderTopRightRadius: '30px', borderBottomRightRadius: '30px' }}>
                          <p className="px-5 py-3 text-white mediumfont">Win a ticket to france</p>
                      ...
                      <div className="position-absolute bottom-0">
                        <div className="d-flex  gap-5 justify-content-between mb-4  align-items-center text-center ">
                          <div className="line-height text-white text-shadow">
                            <p>Grape Stomping Ritual & Wine-Making Contest</p>
                            <p>Private Vineyard Tours</p>
                          </div>
                          <div className="line-height text-white text-shadow">
                            <p>7-Course Organic Culinary Journey</p>
                            <p>Premium Wine Tastings & Pairings</p>
                          </div>
                          <div className="line-height text-white text-shadow">
                            <p>Drone Show Spectacle</p>
                            <p>Jazz Concert Under the Stars</p>
                          </div>
